<template>
  <Modal v-model="dialog">
    <div
      class="min-w-[400px] bg-white dark:bg-slate-800 rounded-md animate-bounce-out"
    >
      <div
        class="flex items-center justify-between p-4 border-b dark:border-slate-700 border-gray-200"
      >
        <h1 class="font-semibold text-xl">Edit JS Links</h1>
        <button
          @click="dialog = false"
        ...
        <form @submit.prevent="addLink">
          <div class="flex space-x-2 mt-3">
            <input
              ...
              required
              v-model="link"
              placeholder="https://example.com/js/min.js"
            />
            <button
              type="submit"
